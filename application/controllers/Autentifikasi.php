...
class Autentifikasi extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($this->form_validation->run() == false) {
            $data['nama'] = 'Login';
            $data['user'] = '';
            //kata 'login' merupakan nilai dari variabel nama dalam array $data dikirimkan ke view aute_header
            $this->load->view('backend/templates/aute_header', $data);
            $this->load->view('backend/autentifikasi/login');
            $this->load->view('backend/templates/aute_footer');
        } else {
            $this->_login();
        }
    }
    ...
    public function registrasi()
    {
        ...
        if ($this->form_validation->run() == false) {
            $data['nama'] = 'Registrasi Member';
            $this->load->view('backend/templates/aute_header', $data);
            $this->load->view('backend/autentifikasi/registrasi');
            $this->load->view('backend/templates/aute_footer');
        } else {
    ...
    {
        $this->load->view('backend/autentifikasi/blok');
    }

    public function gagal()
    {
        $this->load->view('backend/autentifikasi/gagal');
    }
}
